...
class MY_MoCo_V94(BaseModel):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MY_MoCo_V94, self).__init__(init_cfg)
    ...
    def forward_train(self, img, order, **kwargs):
        ...
        im_q = img[1]  ## montage stronger aug 需要提供全局特征和 局部特征
        im_k = img[0]  ## src  weakly aug 在这里，其需要提供全局特征
        im_loc = img[2]  ### 在这里放入到 k_encoder 中，只需要提供局部特征
