...
class MY_MoCo_V3(BaseModel):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MY_MoCo_V3, self).__init__(init_cfg)
    ...
    def forward_train(self, img, **kwargs):
        ...
        l_mix = l_pos_1_mean/l_neg_1_mean
        negative_thresold_1 = 0.7 * l_pos_1_mean
        zero = torch.zeros_like(l_neg_1)
        l_neg_1 = torch.where(l_neg_1 > negative_thresold_1 , zero, l_neg_1)
        ...
        ### select
        negative_thresold_2 = 0.7 * l_pos_2_mean
        l_neg_2 = torch.where(l_neg_2 > negative_thresold_2, zero, l_neg_2)
        ...
        # negative logits: NxK
        ## K should be selected by similary
        l_neg_3 = torch.einsum('nc,ck->nk', [q_3, self._buffers["queue_3"].clone().detach()])
        ### select
        negative_thresold_3 = 0.7 * l_pos_3_mean
        l_neg_3 = torch.where(l_neg_3 > negative_thresold_3, zero, l_neg_3)
        ...
        ### select
        negative_thresold_4 = 0.7 * l_pos_4_mean
        l_neg_4 = torch.where(l_neg_4 > negative_thresold_4, zero, l_neg_4)
        ...
        file_l_neg_1 = open('l_neg_1_mean.txt', mode='a+')

        file_l_mix_1 = open('l_mix_1_mean.txt', mode='a+')
        ...
        file_l_neg_1.write('l_neg_1_mean is {} \n'.format(l_neg_1_mean))

        file_l_mix_1.write('l_mix_1_mean is {} \n'.format(l_mix))
