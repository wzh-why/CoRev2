...
class MY_MoCo_V93(BaseModel):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MY_MoCo_V93, self).__init__(init_cfg)
    ...
    def forward_train(self, img, order,mask, **kwargs):
        ...
        order_list = order
        img4_mask = mask.permute(0,3,1,2)
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            k_1,k_2,k_3,k_4 = align_featuremap(k_loc,order_list)
