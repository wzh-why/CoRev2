...
class MY_MoCo_v4(BaseModel):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MY_MoCo_v4, self).__init__(init_cfg)
    ...
    def forward_train(self, img, **kwargs):
        ...
        print('q_1shape', q_1.shape)
        print('q_2shape', q_2.shape)
        print('q_3shape', q_3.shape)
        print('q_4shape', q_4.shape)

        print('q_1shape', type(q_1))
        print('q_2shape', type(q_2))
        print('q_3shape', type(q_3))
        print('q_4shape', type(q_4))
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            print('k_1shape', k_1.shape)
            print('k_2shape', k_2.shape)
            print('k_3shape', k_3.shape)
            print('k_4shape', k_4.shape)

            print('k_1 type', type(k_1))
            print('k_2 type', type(k_2))
            print('k_3 type', type(k_3))
            print('k_4 type', type(k_4))
        ...
        # src_area = im_q[:,:,84:140,84:140]
        # re_area = re_img[:,:,84:140,84:140]
        ...
        src_area_1 = im_q[:, :, 24:40, 24:40]
        re_area_1 = re_img[:, :, 24:40, 24:40]

        src_area_2 = im_q[:, :, 24:40, 124:164]
        re_area_2 = re_img[:, :, 24:40, 124:164]

        src_area_3 = im_q[:, :, 124:164, 24:40]
        re_area_3 = re_img[:, :, 124:164, 24:40]

        src_area_4 = im_q[:, :, 124:164, 124:164]
        re_area_4 = re_img[:, :, 124:164, 124:164]

        losses['loss_reconstruction'] = 0.25 *0.9* (rec_loss(src_area_1, re_area_1)+rec_loss(src_area_2,re_area_2)
                                                +rec_loss(src_area_3,re_area_3)+rec_loss(src_area_4,re_area_4))
