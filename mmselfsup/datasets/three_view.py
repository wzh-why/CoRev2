...
from .pipelines import BlockwiseMaskGenerator

'''based on the multi_view, aims to obtian three views for corev2'''


@DATASETS.register_module()
class ThreeViewDataset(BaseDataset):
    ...
    Args:
        data_source (dict): Data source defined i
