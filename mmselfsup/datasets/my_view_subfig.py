...
from .pipelines import montage,cutout_subfigure_center

@DATASETS.register_module()
class MontageViewDataset(BaseDataset):  ##
    ...
    def __getitem__(self, idx):
        ...
        img_3 = cutout_subfigure_center(img)

        ##
        multi_views = list(map(lambda trans: trans(img), self.trans))
        multi_views.extend([img_2,img_3])
