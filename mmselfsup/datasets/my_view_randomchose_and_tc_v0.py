...
from .pipelines import montage_PIL,piltotensor,random_subfigure_cutout

@DATASETS.register_module()
class RandomchoiceAndRandcutViewV0(BaseDataset):  ##
    ...
    def __getitem__(self, idx):
        ...
        #     ]
        return dict(img=multi_views,mask=mask)
