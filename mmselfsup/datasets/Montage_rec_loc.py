...
from .pipelines import transform_center,montage,random_choice


@DATASETS.register_module()
class MontageLocViewDataset(BaseDataset):  ##
    ...
    def __getitem__(self, idx):
        ...
        img = self.data_source.get_img(idx)  ### PIL image

        img_2 = montage(img)

        img_3 = transform_center(img)

        img_4,label = random_choice(img)
